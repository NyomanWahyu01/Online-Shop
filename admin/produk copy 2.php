                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form id="form_input">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <img id="gambar-preview" src="upload/" alt="Preview Gambar" style="max-width: 100%; margin-top: 10px; display: none;">
                                                                </div>
                                                                <div class="form-group">
                                                    ...
                                                    <tr>
                                                        ...
                                                        while ($data = mysqli_fetch_array($query)) {
                                                            ...
                                                            echo "
                                                                ...
                                                                <td>
                                                                    <button data-id_produk='$data[id_produk]' 
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(".edit").click(function() {
            ...
            // Menampilkan pratinjau gambar saat mengedit
