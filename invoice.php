        ...
        <div class="mt-product-table">
          <div class="container">
            ...
            <div class="row border">
              <div class="col-xs-12 col-sm-6">
                <strong class="title">PROUK</strong>
              </div>
            ...
            $query = mysqli_query(
              $koneksi,
              "select * from data_keranjang, 
                  data_produk where data_keranjang.id_pesanan='$id_pesanan' 
                  and data_keranjang.id_produk=data_produk.id_produk"
            );
