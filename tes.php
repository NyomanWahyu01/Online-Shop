		...
		<div class="w1">
											...
											<div class="mt-drop-sub">
												...
												<div class="mt-side-widget">
													...
													<div class="cart-row-total">
														...
														<span class="mt-total-txt"><a href="#" class="btn-type2">add to
																CART</a></span>
													</div>
															...
															<div class="sub-dropcont">
																...
																<div class="sub-drop">
																	<ul>
																		...
																		<li><a href="produk-detail.php">Product
																				Detail</a></li>
																		<li><a href="product-detail2.html">Product
																				Detail V2</a></li>
																		<li><a href="order-shopping-cart.html">Shopping
																				Cart</a></li>
																		<li><a href="order-checkout.html">Checkout</a>
																		</li>
																		<li><a href="ordertracking.html">Order
																				Tracking</a></li>
																		<li><a href="wishlist.html">Wish List</a></li>
																		<li><a href="faq.html">FAQ Page</a></li>
																		<li><a href="loginpage.html">Login Page</a></li>
																		<li><a href="registerpage.html">Register
																				Page</a></li>
			...
			<div class="mt-main-slider">
				...
				<div class="slider banner-slider">
					<!-- holder start here -->
					<div class="holder text-center" style="background-image: url(images/sliders/img04.jpg);">
						<div class="container">
							<div class="row">
								<div class="col-xs-12">
									<div class="text centerize">
										...
										<a href="produk-detail.php" class="shop">shop now</a>
									</div>
								</div>
							</div>
						</div>
					...
					<!-- holder start here -->
					<div class="holder text-center" style="background-image: url(images/sliders/img05.jpg);">
						<div class="container">
							<div class="row">
								<div class="col-xs-12">
					...
					<!-- holder start here -->
					<div class="holder text-center" style="background-image: url(images/sliders/img06.jpg);">
						<div class="container">
							<div class="row">
								<div class="col-xs-12">
									<div class="text">
						...
						<div class="col-xs-12">
							...
							<div class="banner-frame">
								...
								<div class="banner-1 wow fadeInLeft" data-wow-delay="0.4s">
									<img alt="image description" src="images/banner/img01.jpg">
									<div class="holder">
										<h2>MY SMALL WRITING <br>DESK</h2>
										<div class="txts">
											<a class="btn-shop" href="produk-detail.php">
												<span>shop now</span>
								...
								<div class="banner-box first">
									...
									<div class="banner-2 wow fadeInUp" data-wow-delay="0.4s">
										<img alt="image description" src="images/banner/img02.jpg">
										<div class="holder">
									...
									<div class="banner-3 right wow fadeInDown" data-wow-delay="0.4s">
										<img alt="image description" src="images/banner/img03.jpg">
										<div class="holder">
								...
								<div class="banner-4 hidden-sm wow fadeInRight" data-wow-delay="0.4s">
									<img alt="image description" src="images/banner/img04.jpg">
									<div class="holder">
										<h2>Direct light <br>pendant lamp</h2>
										<span class="price">$ 129.00</span>
										<a class="btn-shop add" href="produk-detail.php">
											<span>shop now</span>
											<i class="fa fa-angle-right"></i>
										</a>
									</div>
                                                            ...
                                                            <div class='b1'>
                                                                <div class='b2'>
                                                                    ...
                                                                    <ul class='links'>
                                                                        ...
                                                                        <li><a <a href='produk-detail.php?id_produk={$dt['id_produk']}'> class='lightbox'><i class='icomoon icon-eye'></i></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class='txt'>
                                                            <strong class='title'><a href='produk-detail.php'>$dt[merek]</a></strong>
                                                            <span class='price'><i class='fa fa-eur'></i> <span>$dt[harga]</span></span>
                                                        </div>
                                                    </div>";
													$y++;
												}
                                                            ...
                                                            <div class='b1'>
                                                                <div class='b2'>
                                                                    ...
                                                                    <ul class='links'>
                                                                        <li><a href='#'><i class='icon-handbag'></i><span>Add to Cart</span></a></li>
                                                                        <li><a href='#'><i class='icomoon icon-heart-empty'></i></a></li>
                                                                        <li><a <a href='produk-detail.php?id_produk={$data['id_produk']}'> class='lightbox'><i class='icomoon icon-eye'></i></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
									...
									<div class="slide">
										...
										<div class="mt-product1 large">
											<div class="box">
												<div class="b1">
													<div class="b2">
														<a href="produk-detail.php"><img src="images/products/img11.jpg" alt="image description"></a>
														<span class="caption">
											...
											<div class="txt">
												<strong class="title"><a href="produk-detail.php">Bombi
														Chair</a></strong>
									...
									<div class="slide">
										...
										<div class="mt-product1 large">
											<div class="box">
												<div class="b1">
													<div class="b2">
														<a href="produk-detail.php"><img src="images/products/img12.jpg" alt="image description"></a>
														<ul class="links add">
															<li><a href="#"><i class="icon-handbag"></i></a></li>
															<li><a href="#"><i class="icomoon icon-heart-empty"></i></a>
															</li>
											...
											<div class="txt">
												<strong class="title"><a href="produk-detail.php">Marvelous Modern 3
														Seater</a></strong>
									...
									<div class="slide">
										...
										<div class="mt-product1 large">
											<div class="box">
												<div class="b1">
													<div class="b2">
														<a href="produk-detail.php"><img src="images/products/img13.jpg" alt="image description"></a>
														<ul class="links add">
															<li><a href="#"><i class="icon-handbag"></i></a></li>
															<li><a href="#"><i class="icomoon icon-heart-empty"></i></a>
															</li>
											...
											<div class="txt">
												<strong class="title"><a href="produk-detail.php">Puff
														Armchair</a></strong>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-6 col-md-3 mt-paddingbottomsm wow fadeInLeft" data-wow-delay="0.4s">
								...
								<div class="mt-product4 mt-paddingbottom20">
									<div class="img">
										<a href="produk-detail.php"><img alt="image description" src="images/products/img14.jpg"></a>
									</div>
									<div class="text">
										<div class="frame">
											<strong><a href="produk-detail.php">Egon Wooden Chair</a></strong>
											<ul class="mt-stars">
												<li><i class="fa fa-star"></i></li>
												<li><i class="fa fa-star"></i></li>
												<li><i class="fa fa-star"></i></li>
								...
								<div class="mt-product4 mt-paddingbottom20">
									<div class="img">
										<a href="produk-detail.php"><img alt="image description" src="images/products/img15.jpg"></a>
									</div>
									<div class="text">
										<div class="frame">
											<strong><a href="produk-detail.php">Oyo Cantilever Chair</a></strong>
										</div>
										<del class="off">$75,00</del>
										<span class="price">$55,00</span>
									</div>
								...
								<div class="mt-product4 mt-paddingbottom20">
									<div class="img">
										<a href="produk-detail.php"><img alt="image description" src="images/products/img16.jpg"></a>
									</div>
									<div class="text">
										<div class="frame">
											<strong><a href="produk-detail.php">Kurve Chair</a></strong>
											<ul class="mt-stars">
												<li><i class="fa fa-star"></i></li>
												<li><i class="fa fa-star"></i></li>
												<li><i class="fa fa-star"></i></li>
							...
							<div class="col-xs-12 col-sm-6 col-md-3 mt-paddingbottomsm wow fadeInLeft" data-wow-delay="0.4s">
								...
								<div class="mt-product4 mt-paddingbottom20">
									<div class="img">
										<a href="produk-detail.php"><img alt="image description" src="images/products/img17.jpg"></a>
									</div>
									<div class="text">
										<div class="frame">
											<strong><a href="produk-detail.php">Bombi Chair</a></strong>
										</div>
										<del class="off">$75,00</del>
								...
								<div class="mt-product4 mt-paddingbottom20">
									<div class="img">
										<a href="produk-detail.php"><img alt="image description" src="images/products/img18.jpg"></a>
									</div>
									<div class="text">
										<div class="frame">
											<strong><a href="produk-detail.php">Oyo Cantilever Chair</a></strong>
								...
								<div class="mt-product4 mt-paddingbottom20">
									<div class="img">
										<a href="produk-detail.php"><img alt="image description" src="images/products/img19.jpg"></a>
									</div>
									<div class="text">
										<div class="frame">
											<strong><a href="produk-detail.php">Puff Chair</a></strong>
										</div>
										<del class="off">$75,00</del>
										<span class="price">$55,00</span>
									</div>
							...
							<div class="col-xs-12 col-sm-6 col-md-3 mt-paddingbottomxs wow fadeInRight" data-wow-delay="0.4s">
								...
								<div class="mt-product4 mt-paddingbottom20">
									<div class="img">
										<a href="produk-detail.php"><img alt="image description" src="images/products/img20.jpg"></a>
									</div>
									<div class="text">
										<div class="frame">
											<strong><a href="produk-detail.php">Marvelous Wooden Chair</a></strong>
										</div>
										<del class="off">$75,00</del>
										<span class="price">$55,00</span>
									</div>
								...
								<div class="mt-product4 mt-paddingbottom20">
									<div class="img">
										<a href="produk-detail.php"><img alt="image description" src="images/products/img21.jpg"></a>
									</div>
									<div class="text">
										<div class="frame">
											<strong><a href="produk-detail.php">Oyo Cantilever Chair</a></strong>
							...
							<div class="col-xs-12 col-sm-6 col-md-3 text-right">
								...
								<div class="f-widget-about">
									...
									<ul class="list-unstyled address-list align-right">
										...
										<li><i class="fa fa-envelope-o"></i><a href="mailto:&#105;&#110;&#102;&#111;&#064;&#115;&#099;&#104;&#111;&#110;&#046;&#099;&#104;&#097;&#105;&#114;">&#105;&#110;&#102;&#111;&#064;&#115;&#099;&#104;&#111;&#110;&#046;&#099;&#104;&#097;&#105;&#114;</a>
										</li>
									</ul>
								</div>
								<!-- F Widget About of the Page end -->
